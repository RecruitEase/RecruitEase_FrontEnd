          ...
          {slides.map((item) => (
            <div className="embla__slide " key={item.key} >
              ...
              >
                ...
                <div className="col-start-1 col-end-12 row-start-4 row-end-6 flex justify-start items-end text-left font-bold lg:text-xl  md:text-large text-xl text-black whitespace-nowrap overflow-hidden">
                  {item.title}
                </div>
                <button className="col-start-12 col-end-13 row-start-4 row-end-6 flex items-end justify-center bg-transparent hover:fill-black">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="13"
                    height="20.452"
                ...
                <div className="col-start-1 col-end-12 row-start-6 row-end-7 flex justify-start  text-left  text-medium text-black whitespace-nowrap overflow-hidden">
                  {item.company}
                </div>
                <div className="col-start-1 col-span-1 row-start-8 row-span-1 flex justify-center items-center overflow-hidden">
                  <ImLocation size={17} />
                </div>
                <div className="col-start-2 col-end-12 row-start-8 row-span-1 flex justify-start items-center overflow-hidden">
                  {item.location}
                </div>
                <div className="col-start-1 col-span-1 row-start-9 row-span-1 flex justify-center items-center overflow-hidden">
                  <ImBriefcase size={17} />
                </div>
                <div className="col-start-2 col-end-12 row-start-9 row-span-1 flex justify-start items-center overflow-hidden">
                  {item.type}
                </div>
              </div>
            </div>
