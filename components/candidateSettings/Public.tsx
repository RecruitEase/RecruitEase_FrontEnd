          ...
          <div className="items-center mt-8 sm:mt-14 text-[#202142]">
            <div
                ...
                <Input
                    ...
                    type="text"
                    label="First Name"
                    defaultValue={candidateQuery.data!.firstName}
                ...
                <Input
                    ...
                    type="text"
                    label="Last Name"
                    defaultValue={candidateQuery.data!.lastName}
                    className="col-span-12 md:col-span-4  mb-2"
                />
                <Input
                    disabled={true}
              ...
              <Textarea
                  ...
                  defaultValue={candidateQuery.data!.address}
              ...
              <Input
                  ...
                  type="text"
                  label="City"
                  defaultValue={candidateQuery.data!.city}
              ...
              <Textarea
                  ...
                  label="About Me"
                  labelPlacement="inside"
                  defaultValue={candidateQuery.data!.aboutMe}
                  className="col-span-12 mb-2"
              />
