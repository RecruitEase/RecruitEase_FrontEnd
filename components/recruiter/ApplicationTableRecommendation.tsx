...
const columns = [
    ...
    {name: "Matching Percentage", uid: "match"},
];
...
const INITIAL_VISIBLE_COLUMNS = ["name", "appliedDate","match"];


export default function ApplicationTableRecommendation({recommendations,applications,candidates,setSelectedApplication}:{recommendations:RecommendationProps[],  applications: ApplicationProp[],candidates: CandidateProp[],setSelectedApplication:React.Dispatch<React.SetStateAction<ApplicationProp | null>>}) {
    ...
    const renderCell = React.useCallback((user: User, columnKey: React.Key) => {
        ...
        switch (columnKey) {
            ...
            case "match":
                return (
                    <div className="flex flex-col">
                        <p className="text-bold text-small capitalize">{recommendations.find((r)=>r.applicationId==user.applicationId)?.matchPercentage}</p>
                    </div>
                );
            // case "status":
            //     return (
