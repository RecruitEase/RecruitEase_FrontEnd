            ...
            <div className='flex flex-col md:flex-row md:gap-x-6 lg:gap-x-0 xl:grid xl:grid-cols-2 mt-4'>
                    ...
                    <motion.div initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 0.3, delay: 1.5}}
                        ...
                        <a href="/"
                           className='inline-flex relative z-10 h-10 rounded-xl p-px shadow-lg'>
                            <div
                                className='flex items-center gap-1 px-6 font-medium rounded-xl whitespace-nowrap bg-recruitBlue text-white'>
                ...
                <div className='hidden md:block pt-3 shrink grow overflow-hidden z-10'>
                    <motion.div initial={{opacity: 0, x: -300}} animate={{opacity: 1, x: 0}}
                        ...
                        <div
                            className='relative p-px overflow-hidden rounded-3xl sm:rounded-[2rem] bg-gradient-to-br from-white to-zinc-600'>
                            <div
                                className='rounded-3xl sm:rounded-[31px] overflow-hidden p-1.5 bg-gradient-to-br from-zinc-400 to-zinc-700'>
                                <div
                                    className='rounded-[17px] sm:rounded-[25px] overflow-hidden bg-gradient-to-br from-zinc-800 to-zinc-950'>
                                    <Image src='/image1.webp' className='object-cover object-center' width={1000}
                                           height={1000} alt='Hero-Image'/>
                                    <div className='absolute inset-0 bg-black/30 flex items-center justify-center'>
                                        <button
                                            className='inline-flex h-10 rounded-xl p-px bg-gradient-to-br from-[#84B2E5] to-[#2F6EB1] shadow-lg'>
                                            <div
                                                className='flex h-full items-center gap-2 px-6 font-medium rounded-[11px] bg-gradient-to-br from-[#4B91DE] to-[#276AB2] text-white button-hover'>
