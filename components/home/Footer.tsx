  ...
  return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          />)}
                    ...
                    <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Your go to solution for both job finding and recruiting</p>
                    <a href="javascript:;"  className="py-2.5 px-5 h-9 block w-fit bg-recruitBlue rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                        Contact us
                    </a>
                </div>
                <div className="lg:mx-auto text-left ">
                    <h4 className="text-lg text-gray-900 font-medium mb-7">RecruitEase</h4>
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©<a href="https://RecruitEase.io/">RecruitEase</a> 2024, All rights reserved.</span>
