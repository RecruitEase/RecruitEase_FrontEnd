...
export default function Public() {
  ...
  const recruiterQuery=useRecruiter(session?.user.roleDetails.recruiterId)

  useEffect(() => {
    if(recruiterQuery.isSuccess) {
      setFirstName(recruiterQuery.data!.firstName)
      setLastName(recruiterQuery.data!.lastName)
      setCity(recruiterQuery.data!.city)
    ...
    setReload(false)
  }, [recruiterQuery.data,reload]);

  function uploadImage(url:string){
    axios.put(`${process.env.NEXT_PUBLIC_API_URL}/user/update-recruiter`,{
      "profilePic":url
    })
        .then(response =>{
  ...
  function updateData(){
    ...
    setIsLoading(true)
    axios.put(`${process.env.NEXT_PUBLIC_API_URL}/user/update-recruiter`,data)
        .then(response =>{
          if(response.status === 200){
    ...
    return (
        <div className="p-2 md:p-4">
          <div className="w-full px-6 pb-8 mt-8  sm:rounded-lg">
            <h2 className="pl-6 text-2xl font-bold sm:text-xl">Company Details</h2>
            <div className="grid mx-auto mt-8">
              <div className="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0">
                <img
                    ...
                    src={data?.profilePic?process.env.NEXT_PUBLIC_S3_URL+data.profilePic:"/profileImages/noImage.png"}
              ...
              <div className="items-center mt-8 sm:mt-14 text-[#202142]">
                ...
                <div>
                  <h2 className="mb-4 mt-8 text-2xl font-bold sm:text-xl">Company Representative</h2>
