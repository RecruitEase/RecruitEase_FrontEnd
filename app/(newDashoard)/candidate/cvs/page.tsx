  ...
  return (
      <div>
        <header className="home-header">
          <HeaderBox type="title" title="CV Library" subtext="Manage your CVs here."/>
        </header>
          <div className=' w-full flex justify-end gap-2'>
            <Button className='bg-recruitBlue text-white' as={Link} href={"/candidate/cvs/create"}>
              Create
            </Button>
                ...
                <div key={"cv" + item.key} id={"cv" + item.key} className=' relative group'>
                  <Card
                    ...
                    <CardHeader
                      ...
                      <Button className=' bg-recruitBlue' as={Link} href="/candidate/cvs/view">
                        View CV
                      </Button>
                    </CardHeader>
                  </Card>
