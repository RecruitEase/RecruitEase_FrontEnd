      ...
      themes: {
        light: {
          ...
          colors: {
            ...
            //application status
            allApplicants: "#E3F2FD",
            preScreeningPassed: "#E8F5E9",
            preScreeningFailed: "#FFEBEE",
            shortlisted: "#FFFDE7",
            interviewScheduled: "#F3E5F5",
            interviewed: "#E0F7FA",
            offered: "#FFF3E0",
            hired: "#F9FBE7",
            rejected: "#FCE4EC",
        ...
        dark: {
          ...
          colors: {
            ...
            //application status
            allApplicants: "#1E3A8A",
            preScreeningPassed: "#827717",
            preScreeningFailed: "#B71C1C",
            shortlisted: "#F57F17",
            interviewScheduled: "#6A1B9A",
            interviewed: "#006064",
            offered: "#E65100",
            hired: "#2E7D32",
            rejected: "#880E4F",
